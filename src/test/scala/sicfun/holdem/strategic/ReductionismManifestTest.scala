...
class ReductionismManifestTest extends FunSuite:
  ...
  val manifest: Vector[Reductionism] = Vector(
    ...
    Reductionism("SE-002", "engine/StrategicEngine.scala:90",
      ...
      Severity.Silent, "Wave 4"),
    Reductionism("SE-003", "engine/StrategicEngine.scala:221",
      "ShowdownKernel is no-op — Def 18 showdown evidence discarded",
      Severity.Silent, "Wave 3"),
    Reductionism("SE-004", "engine/StrategicEngine.scala:134",
      "endHand discards showdown data — cross-hand learning dead",
      Severity.Silent, "Wave 3"),
    Reductionism("SE-005", "engine/StrategicEngine.scala:77",
      "showdown = None hardcoded in observeAction — showdown signals never flow",
      Severity.Silent, "Wave 3"),
